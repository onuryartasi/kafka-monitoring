...
#promethes jvm options 

KAFKA_OPTS="$KAFKA_OPTS -javaagent:/opt/kafka/prometheus/jmx_prometheus_javaagent-0.9.jar=7071:/opt/kafka/prometheus/kafka-2_0_0.yml"
#KAFKA_OPTS="$KAFKA_OPTS -javaagent:/opt/kafka/prometheus/jmx_prometheus_javaagent-0.9.jar=7071"
